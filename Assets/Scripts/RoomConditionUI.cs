...
{//이미지 변수List선언
    ...
    private void UpdateCrewImages()
    {
        ...
        while (imposterCount != 0)
        {
            ...
            if (crewImgs[idx].material.GetColor("Last_Color") != Color.red && Random.Range(0, 5) == 0)
            {
                crewImgs[idx].material.SetColor("Last_Color", Color.red);
                imposterCount--;
            }
            idx++;
        }
